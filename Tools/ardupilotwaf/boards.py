...
#                '-Werror=shorten-64-to-32',  # ARRAY_SIZE() creates this all over the place as the caller typically takes a uint32_t not a size_t
            ...
            if self.cc_version_gte(cfg, 14, 0) and self.cc_version_lte(cfg, 16, 99):
                ...
                # NOTE: local workaround - extend the exclusion to all 16.x
                # releases (this host builds with GCC 16.2.1 which still hits
